<en_url>https://www.bib.uni-mannheim.de/en/resources/subject-specific-research/mathematics-and-informatics/</en_url>


# Mathematik und Informatik (https://www.bib.uni-mannheim.de/medien/fachliche-recherche/mathematik-und-informatik/)



## Für die Fächer Mathematik und Informatik bieten wir Ihnen Literatur, Datenbanken und weitere Sucheinstiege.
...
Weitere Datenbanken zur Mathematik (https://www.bib.uni-mannheim.de/medien/datenbanken/?libconnect%5Bsubject%5D=21&libconnect%5Bsort%5D=alph), Informatik (https://www.bib.uni-mannheim.de/medien/datenbanken/?libconnect%5Bsubject%5D=15&libconnect%5Bsort%5D=alph) und zu anderen Fach­gebieten finden Sie über das Datenbank-Info­system Datenbank-Info­system (DBIS).
...
und im Katalog Primo (https://primo.bib.uni-mannheim.de/primo-explore/search?vid=MAN_UB).
...
Morgan Claypool: Computer & Information Science Collections (https://www.morganclaypool.com/page/csc)
Diese und weitere E-Books finden Sie auch im Katalog Primo (https://primo.bib.uni-mannheim.de/primo-explore/search?vid=MAN_UB).
...
Regelmäßig findet im Bereich Informatik statt:
Kurs für Studierende im Master Wirtschafts­informatik und Mannheim Master in Data Science (auf Englisch)Scientific Research (https://ilias.uni-mannheim.de/goto.php?target=crs_1074660&client_id=ILIAS)
Unregelmäßig oder auf Anfrage finden weitere Schulungen im Bereich Mathematik statt. Einige Präsentationen von vergangenen Veranstaltungen sind hier verfügbar:
Literatur- und Informations­recherche für die Abschlussarbeit
How to write good mathematical articles?
Außerdem bietet die UB allgemeine Kurse und Online-Tutorials an. Unsere Tutorials können Sie jederzeit online absolvieren. Gerne beraten wir Sie auch individuell.
...
* Brink, A. (2013). Anfertigung wissenschaft­licher Arbeiten (https://link.springer.com/book/10.1007%2F978-3-658-02511-3). Wiesbaden: Springer Fach­medien Wiesbaden. Signatur: 120 AK 39540 B858(5) (https://primo.bib.uni-mannheim.de/permalink/f/17313ps/MAN_ALMA21132225730002561)
* Teichert, A. (2013). Erfolgreich recherchieren – Mathematik (https://www.degruyter.com/view/title/125880). Berlin, Boston: De Gruyter Saur. Signatur: 2013 A 2729 (https://primo.bib.uni-mannheim.de/permalink/f/17313ps/MAN_ALMA21142414670002561)
...
* Technischer Support, Weiter- und Software­entwicklung von Content-Management-Systemen
* Beratung und Schulungen im Bereich Forschungs­daten­management
* Literatur­auswahl und -erschließung für das Fach Mathematik
...
Vertretung Fach­referate für Mathematik und Informatik: Stefan Weil (https://www.bib.uni-mannheim.de/stefan-weil/)
