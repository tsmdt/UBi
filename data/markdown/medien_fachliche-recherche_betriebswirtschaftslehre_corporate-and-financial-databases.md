...
| M&A and owner­ship structure | Aktienführer data archive,Zephyr | Zephyr | Zephyr | SDC Worldwide M&A,Zephyr |
...
Extended Access: For bulk download of large datasets („Orbis Generics“) as well as for historic updates an extended access option is available for Orbis. Extended access can be used by professors and academic staff of Mannheim University, including student thesis supervised by these persons. For usage a special username/password is required, which is ad­ministered by the Dean's Office of the Business School. Please contact orbis@uni-mannheim.de to reserve access.
