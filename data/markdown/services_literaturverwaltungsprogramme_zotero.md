...
## Zotero können Sie als Open-Source-Software kostenlos für die Literatur­verwaltung unter Windows, macOS oder Linux nutzen.
...
* Literatur­nachweise sammeln, ordnen, mit Tags versehen und annotieren
* Volltexte speichern und durchsuchen
* Mit dem Plugin für Microsoft Word und LibreOffice Zitationen in den Text einfügen und Literatur­verzeichnisse automatisch erstellen
* Zitations­stil auswählen oder anpassen
* Integration in GoogleDocs
...
Die aktuelle Kurse sind auf der Events-Seite der UB (https://www.bib.uni-mannheim.de/ihre-ub/aktuelles/events/) zu finden.
Bei Bedarf bieten wir nach Vereinbarung gerne zusätzliche Kurse an.


## Aufzeichnungen

Literatur­verwaltung mit Zotero (Video, Präsentation – Deutsch) (https://cloud.bib.uni-mannheim.de/s/aWFdsESpmsqCsik)​
Reference Management with Zotero (Video, Presentation, Worksheet – English) (https://cloud.bib.uni-mannheim.de/s/na5n3GdCT8Qtf3A)
**Kontakt**
Vereinbaren Sie einen Beratungs­termin oder senden Sie Ihre Fragen an litverw.ub@uni-mannheim.de.
...
### Team Literatur­verwaltung

* Adresse: Universität Mannheim, Universitäts­bibliothek, Schloss, Schneckenhof West, 68161 Mannheim
* Web: [www.bib.uni-mannheim.de/literatur­verwaltungs­programme](/services/literaturverwaltungsprogramme/)
