---
title: Corporate and Financial Databases
source_url: https://www.bib.uni-mannheim.de/medien/fachliche-recherche/betriebswirtschaftslehre/corporate-and-financial-databases/
category: Medien
tags: [Datenbanken, Finanzdaten, Unternehmensdaten, Forschung, Mannheim]
language: de
---
...
**Help:** For more detailed information on the I/B/E/S files, see the documentation and manuals page available via WRDS.  
Access: via [WRDS](https://wrds-www.wharton.upenn.edu/login/) (requires registration)
...
* [LSEG Finance Essentials](https://www.lseg.com/en/training/learning-centre/certification/lsegfe-certification) – self-paced eLearning program covering everything from economics to currencies to the stock market
* [LSEG Workspace online tutorials and courses](https://www.lseg.com/en/training/learning-centre/)
* [Tutorials for Working with Excel Add In](https://www.lseg.com/content/lseg/en_us/training/learning-centre/learning-centre-catalogue/video-details.html?id=getting-started-with-refinitiv-workspace-excel-add-in&playlistId=1_6rg1cjpw)
...
Extended Access: For bulk download of large datasets (“Orbis Generics”) as well as for historic updates an extended access option is available for Orbis. Extended access can be used by professors and academic staff of Mannheim University, including student thesis supervised by these persons. For usage a special username/password is required, which is administered by the Dean's Office of the Business School. Please contact [orbis@uni-mannheim.de](mailto:orbis@uni-mannheim.de) to reserve access.
