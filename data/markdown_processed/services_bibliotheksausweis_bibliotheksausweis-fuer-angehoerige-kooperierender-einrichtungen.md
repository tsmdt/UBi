---
title: Bibliotheksausweis für Angehörige kooperierender Einrichtungen der Universitätsbibliothek Mannheim
...
category: Benutzung
tags: [Bibliotheksausweis, kooperierende Einrichtungen, ecUM, Anmeldung, Ausleihe, Ersatzkarte, Zugangsdaten, InfoCenter]
language: de
---

# Bibliotheksausweis für Angehörige kooperierender Einrichtungen

Angehörige von Einrichtungen mit einem Kooperationsvertrag zur Bibliotheksnutzung mit der Universität Mannheim können kostenlos online die elektronische Chipkarte ecUM als Bibliotheksausweis beantragen.
...
- lizenzierte elektronische Medien an den PCs der UB nutzen (kein Fernzugriff)
...
1. [Anmeldeformular](https://www.bib.uni-mannheim.de/services/bibliotheksausweis/anmeldung-fuer-privatpersonen-und-angehoerige-von-kooperierenden-einrichtungen/) ausfüllen, speichern, ausdrucken und unterschreiben. Sie erhalten das ausgefüllte Formular zusätzlich als PDF per E-Mail.
2. Ausdruck zusammen mit Personalausweis (oder Reisepass mit Meldebescheinigung) einscannen und per E-Mail an [itsupport@uni-mannheim.de](mailto:itsupport@uni-mannheim.de) senden.
3. Studierende fügen einen Scan des aktuellen Studierendenausweises bei.
4. Mitarbeitende lassen die Zugehörigkeit durch einen Stempel der Einrichtung auf dem Anmeldeformular bestätigen.
5. Nach Erhalt der Zugangsdaten per E-Mail können Sie sich im [Studierendenportal](https://portal2.uni-mannheim.de/portal2/pages/cs/sys/portal/hisinoneStartPage.faces?chco=y) anmelden.
6. Abholung der ecUM zu den Öffnungszeiten der [UNIT im InfoCenter](https://www.bib.uni-mannheim.de/standorte/infocenter/).

Studierende und Mitarbeitende der DHBW Mannheim melden sich über die [DHBW-Bibliothek](https://www.mannheim.dhbw.de/service/bibliothek/ansprechpersonen) an.

**Hinweis:** Ab 1. Juli 2025 wird die ecUM ohne Foto, dafür mit QR-Code ausgestellt. Bestandskarten bleiben weiterhin gültig.
...
- Benachrichtigungen (z. B. Vormerkungen, Mahnungen) werden an die universitäre E-Mail-Adresse gesendet.
- Adressänderungen sind nur persönlich an der Infotheke im InfoCenter möglich (Personalausweis oder Reisepass mit Meldebescheinigung erforderlich).
